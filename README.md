...
<head>
  ...
  <link rel="shortcut icon" type="image/x-icon" href="/vpn-project/favicon.ico" />
  ...
  <header>
    <div class="container" style="
      ...
      <section id="downloads">
        <button type="button">
          <a href="https://github.com/Warns/vpn-project" style="font-family: monospace; text-decoration: none">
  ...
  <div class="container">
    <section id="main_content">
      ...
      <body>
        ...
        <div id="demo" style="height: 400px; position: relative; overflow: hidden"></div>
